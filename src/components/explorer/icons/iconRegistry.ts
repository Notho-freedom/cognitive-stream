...
export const locationIcons = {
  ...
  // Generic folder
  folder: 'https://cdn.jsdelivr.net/gh/PKief/vscode-material-icon-theme@latest/icons/folder.svg',
  folderOpen: 'https://cdn.jsdelivr.net/gh/PKief/vscode-material-icon-theme@latest/icons/folder-open.svg',
