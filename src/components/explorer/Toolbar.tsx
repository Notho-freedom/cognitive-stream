import { ArrowLeft, ArrowRight, ArrowUp, ChevronRight, Search, LayoutGrid, GalleryHorizontalEnd, PanelRight, Scissors, Copy, Clipboard, Trash2, PenLine, SlidersHorizontal, GripHorizontal, LayoutList, Table2, RefreshCw, Eye, FileText, Columns3, Columns2, MoreHorizontal, TerminalSquare } from 'lucide-react';
